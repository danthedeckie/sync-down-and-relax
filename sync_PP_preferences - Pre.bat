...
"C:\Program Files (x86)\Renewed Vision\ProPresenter 6\ProPresenter.exe"
"I:\Public Ministries\AV Team\02 - Sync Data & Backups\0 - Software & Drivers\Computer sync scripts\Run PP & Synchronise"